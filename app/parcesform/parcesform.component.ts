...
dis(){
  ...
  //   this.final= (this.total*this.quantity)-((this.total*this.quantity)*(this.discountResult/100)+(this.quantity*10))
  //   this.quantityOff=''
  //   this.quantityOff='Off TK'+this.quantity*10+' for '+this.quantity+' items parces'
  //   this.t='Discount for cupon is TK '+this.discountResult+' %'
  // }


  // if(this.quantity>4){
  //   this.final= (this.total*this.quantity)-((this.total*this.quantity)*(this.discountResult/100)+(this.quantity*20))
  //   this.quantityOff=''
  //   this.quantityOff='Off TK '+this.quantity*20+' for '+this.quantity+' items parces'
  //   this.t='Discount for cupon is TK '+this.discountResult+' %'
  //   this.netprice=this.total*this.quantity
    

  // }

  // else{
  //   this.final= (this.total*this.quantity)-((this.total*this.quantity)*(this.discountResult/100))
  //   this.t='Discount for cupon is TK '+this.discountResult+' %'
  //   this.quantityOff=''
  //   this.netprice=this.total*this.quantity
  // }
  // this.successmsg='';
  // this.successmsg='Parchase Successfuly';
